...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {{-- Books --}}
        <div class="bg-indigo-50 border-l-4 border-indigo-500 rounded-lg p-5 shadow-sm">
        ...
        {{-- Authors --}}
        <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-5 shadow-sm">
        ...
        {{-- Loans --}}
        <div class="bg-pink-50 border-l-4 border-pink-500 rounded-lg p-5 shadow-sm">
                    ...
                    <tbody>
                        @foreach($recentLoans as $loan)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4">{{ $loan->borrowed_at ? $loan->borrowed_at->format('M d, Y') : '-' }}</td>
                                <td class="py-3 px-4">{{ $loan->due_at ? $loan->due_at->format('M d, Y') : '-' }}</td>
                                <td class="py-3 px-4">
